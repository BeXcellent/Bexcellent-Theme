...
<<<<<<< HEAD
		...
		<div id ="l2" class="linkbubble" style="left: 295px; top: 200px;">
			<img class="linkbubble" src="images/articles.jpg" alt="Articles">
		</div>
		<div id ="l3" class="linkbubble" style="left: 400px; top: 280px;">
			<a href="http://bexcellent.cottagelabs.com/about"><img class="linkbubble" src="images/about.jpg" alt="About"></a>
		</div>
		<div id ="l4" class="linkbubble" style="left: 475px; top: 155px;">
			<a href="http://bexcellent.cottagelabs.com/photos"> <img class="linkbubble" src="images/photos.jpg" alt="Photos"></a>
		</div>
		<div id ="l5" class="linkbubble" style="left: 270px; top: 415px;">
			<img class="linkbubble" src="images/games.jpg" alt="Games">
		</div>
		<div id ="l6" class="linkbubble" style="left: 555px; top: 365px;">
			<img class="linkbubble" src="images/news.jpg" alt="News">
		</div>
		<div id ="l7" class="linkbubble" style="left: 695px; top: 470px;">
			<img class="linkbubble" src="images/parents.jpg" alt="Parents">
		</div>
		<div id ="l8" class="linkbubble" style="left: 50px; top: 55px;">
			<img class="linkbubble" src="images/5-8.jpg" alt="5-8">
		</div>
		<div id ="l9" class="linkbubble" style="left: 585px; top: 40px;">
			<img class="linkbubble" src="images/8-12.jpg" alt="8-12">
		</div>
