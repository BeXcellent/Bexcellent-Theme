	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main" role="main">
			...
			<section class="error-404 not-found">
				...
				<img src="/wp-content/themes/Bexcellent-Theme/sadface.jpg" display:"block" margin-left:"auto" margin-right:"auto" height=250 weight=250 />
...
<h3 color="#484848" align="center">Or (If you want to) You can look at this picture about CfE instead...</h3>
					<img src="/wp-content/themes/Bexcellent-Theme/cfe.jpg" display:"block" margin-left:"auto" margin-right:"auto" />
				</div>
			</section>
